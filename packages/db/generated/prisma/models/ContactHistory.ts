...
// @ts-nocheck 
/*
 * This file exports the `ContactHistory` model and its related types.
 *
...
export type GetContactHistoryAggregateType<T extends ContactHistoryAggregateArgs> = {
      [P in keyof T & keyof AggregateContactHistory]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateContactHistory[P]>
    : Prisma.GetScalarType<T[P], AggregateContactHistory[P]>
}
...
type GetContactHistoryGroupByPayload<T extends ContactHistoryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ContactHistoryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ContactHistoryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ContactHistoryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ContactHistoryGroupByOutputType[P]>
      }
    >
  >
...
export type ContactHistoryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ContactHistoryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ContactHistoryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ContactHistory'], meta: { name: 'ContactHistory' } }
  /**
   ...
   * })
  **/
  count<T extends ContactHistoryCountArgs>(
    args?: Prisma.Subset<T, ContactHistoryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ContactHistoryCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ContactHistoryGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ContactHistoryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetContactHistoryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
