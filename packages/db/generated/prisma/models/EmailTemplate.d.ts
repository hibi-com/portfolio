...
export type GetEmailTemplateAggregateType<T extends EmailTemplateAggregateArgs> = {
    [P in keyof T & keyof AggregateEmailTemplate]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateEmailTemplate[P]> : Prisma.GetScalarType<T[P], AggregateEmailTemplate[P]>;
};
...
type GetEmailTemplateGroupByPayload<T extends EmailTemplateGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<EmailTemplateGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof EmailTemplateGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], EmailTemplateGroupByOutputType[P]> : Prisma.GetScalarType<T[P], EmailTemplateGroupByOutputType[P]>;
}>>;
export type EmailTemplateWhereInput = {
    ...
    category?: Prisma.EnumEmailTemplateCategoryFilter<"EmailTemplate"> | $Enums.EmailTemplateCategory;
    ...
    variables?: Prisma.StringNullableFilter<"EmailTemplate"> | string | null;
...
export type EmailTemplateScalarWhereWithAggregatesInput = {
    ...
    category?: Prisma.EnumEmailTemplateCategoryWithAggregatesFilter<"EmailTemplate"> | $Enums.EmailTemplateCategory;
    ...
    variables?: Prisma.StringNullableWithAggregatesFilter<"EmailTemplate"> | string | null;
...
export type EmailTemplateOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "slug" | "description" | "category" | "subject" | "htmlContent" | "textContent" | "variables" | "isActive" | "createdAt" | "updatedAt", ExtArgs["result"]["emailTemplate"]>;
...
export type EmailTemplateCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<EmailTemplateFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface EmailTemplateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends EmailTemplateCountArgs>(args?: Prisma.Subset<T, EmailTemplateCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], EmailTemplateCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends EmailTemplateGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, EmailTemplateGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEmailTemplateGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface EmailTemplateFieldRefs {
    ...
    readonly category: Prisma.FieldRef<"EmailTemplate", 'EmailTemplateCategory'>;
