...
// @ts-nocheck 
/*
 * This file exports the `DealFreeeMapping` model and its related types.
 *
...
export type GetDealFreeeMappingAggregateType<T extends DealFreeeMappingAggregateArgs> = {
      [P in keyof T & keyof AggregateDealFreeeMapping]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDealFreeeMapping[P]>
    : Prisma.GetScalarType<T[P], AggregateDealFreeeMapping[P]>
}
...
type GetDealFreeeMappingGroupByPayload<T extends DealFreeeMappingGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DealFreeeMappingGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DealFreeeMappingGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DealFreeeMappingGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DealFreeeMappingGroupByOutputType[P]>
      }
    >
  >
...
export type DealFreeeMappingCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DealFreeeMappingFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DealFreeeMappingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DealFreeeMapping'], meta: { name: 'DealFreeeMapping' } }
  /**
   ...
   * })
  **/
  count<T extends DealFreeeMappingCountArgs>(
    args?: Prisma.Subset<T, DealFreeeMappingCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DealFreeeMappingCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DealFreeeMappingGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DealFreeeMappingGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDealFreeeMappingGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
