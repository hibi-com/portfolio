...
// @ts-nocheck 
/*
 * This file exports the `InquiryResponse` model and its related types.
 *
...
export type GetInquiryResponseAggregateType<T extends InquiryResponseAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateInquiryResponse[P]>
    : Prisma.GetScalarType<T[P], AggregateInquiryResponse[P]>
}
...
type GetInquiryResponseGroupByPayload<T extends InquiryResponseGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<InquiryResponseGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof InquiryResponseGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], InquiryResponseGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], InquiryResponseGroupByOutputType[P]>
      }
    >
  >
...
export type InquiryResponseCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface InquiryResponseDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends InquiryResponseCountArgs>(
    args?: Prisma.Subset<T, InquiryResponseCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], InquiryResponseCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, InquiryResponseGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInquiryResponseGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
