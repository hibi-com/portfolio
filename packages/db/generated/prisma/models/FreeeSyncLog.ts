...
// @ts-nocheck 
/*
 * This file exports the `FreeeSyncLog` model and its related types.
 *
...
export type GetFreeeSyncLogAggregateType<T extends FreeeSyncLogAggregateArgs> = {
      [P in keyof T & keyof AggregateFreeeSyncLog]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateFreeeSyncLog[P]>
    : Prisma.GetScalarType<T[P], AggregateFreeeSyncLog[P]>
}
...
type GetFreeeSyncLogGroupByPayload<T extends FreeeSyncLogGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<FreeeSyncLogGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof FreeeSyncLogGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], FreeeSyncLogGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], FreeeSyncLogGroupByOutputType[P]>
      }
    >
  >
...
export type FreeeSyncLogCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<FreeeSyncLogFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface FreeeSyncLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['FreeeSyncLog'], meta: { name: 'FreeeSyncLog' } }
  /**
   ...
   * })
  **/
  count<T extends FreeeSyncLogCountArgs>(
    args?: Prisma.Subset<T, FreeeSyncLogCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], FreeeSyncLogCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends FreeeSyncLogGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, FreeeSyncLogGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFreeeSyncLogGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
