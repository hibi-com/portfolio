...
const AddParticipantInput = z
  ...
  .passthrough();
const Chats_markMessagesAsRead_Body = z
...
const CreateInquiryResponseInput = z
  ...
  .passthrough();
const FreeeCallbackInput = z
  .object({ code: z.string(), state: z.string() })
  .passthrough();
const FreeeIntegration = z
  .object({
    id: z.string(),
    userId: z.string(),
  ...
  .passthrough();
const FreeeAuthUrlResponse = z.object({ url: z.string() }).passthrough();
const FreeeCompany = z
  .object({ id: z.number().int(), displayName: z.string(), role: z.string() })
  .passthrough();
const CreateFreeeIntegrationInput = z
  .object({
    userId: z.string(),
    companyId: z.number().int(),
    companyName: z.string().optional(),
...
const CustomerFreeeMapping = z
  ...
  .passthrough();
const CreateCustomerMappingInput = z
  .object({
    customerId: z.string(),
    freeePartnerId: z.number().int(),
    freeeCompanyId: z.number().int(),
...
const DealFreeeMapping = z
  ...
  .passthrough();
const CreateDealMappingInput = z
  .object({
    dealId: z.string(),
    freeeDealId: z.number().int(),
    freeeCompanyId: z.number().int(),
...
const FreeePartner = z
  ...
  .passthrough();
const SyncDirection = z.enum(["IMPORT", "EXPORT", "BIDIRECTIONAL"]);
const SyncStatus = z.enum(["PENDING", "IN_PROGRESS", "COMPLETED", "FAILED"]);
const SyncErrorDetail = z
  .object({ record: z.string(), error: z.string() })
  .passthrough();
const FreeeSyncLog = z
  .object({
    id: z.string(),
...
const UpdateSyncLogInput = z
  ...
  .partial()
  .passthrough();
const UpdateFreeeTokensInput = z
  .object({
    accessToken: z.string(),
    refreshToken: z.string(),
    tokenExpiresAt: z.string(),
...
const endpoints = makeApi([
  ...
  },
  {
    ...
    response: z.union([
      z.array(Deal),
      z.object({ data: z.array(Deal), meta: PaginationMeta }).passthrough(),
    ]),
  },
  {
    method: "post",
  ...
  },
  {
    ...
    response: z.union([
      z.array(Lead),
      z.object({ data: z.array(Lead), meta: PaginationMeta }).passthrough(),
    ]),
  },
  {
    method: "post",
    ...
    parameters: [
      {
        ...
        type: "Query",
        schema: z
          .enum(["MARKETING", "TRANSACTIONAL", "SUPPORT", "NOTIFICATION"])
          .optional(),
      },
      {
        name: "isActive",
  ...
  },
  {
    ...
    response: z.union([
      z.array(Portfolio),
      z
        .object({ data: z.array(Portfolio), meta: PaginationMeta })
        .passthrough(),
    ]),
  },
  {
  ...
  },
  {
    ...
    response: z.union([
      z.array(Post),
      z.object({ data: z.array(Post), meta: PaginationMeta }).passthrough(),
    ]),
  },
  {
    method: "get",
    ...
    response: z.union([
      z.array(Inquiry),
      z.object({ data: z.array(Inquiry), meta: PaginationMeta }).passthrough(),
    ]),
  },
  {
    method: "post",
  ...
  {
    method: "post",
    path: "/freee/auth/callback",
    alias: "Freee_handleCallback",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: FreeeCallbackInput,
      },
    ],
    response: z.union([FreeeIntegration, ErrorResponse]),
  },
  {
    method: "get",
    path: "/freee/auth/url",
    alias: "Freee_getAuthUrl",
    requestFormat: "json",
    response: z.union([FreeeAuthUrlResponse, ErrorResponse]),
  },
  {
    method: "get",
    path: "/freee/companies",
    alias: "Freee_getCompanies",
    requestFormat: "json",
    response: z.union([z.array(FreeeCompany), ErrorResponse]),
  },
  {
    method: "get",
    path: "/freee/integration",
    alias: "Freee_getIntegration",
    requestFormat: "json",
    response: z.union([FreeeIntegration, ErrorResponse]),
  },
  {
    method: "delete",
    path: "/freee/integration",
    alias: "Freee_disconnectIntegration",
    requestFormat: "json",
    response: z
      .object({ error: z.string(), details: z.unknown().optional() })
      .passthrough(),
  ...
  {
    method: "post",
    path: "/freee/integrations",
    alias: "Freee_createIntegration",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CreateFreeeIntegrationInput,
      },
    ],
    response: z.union([FreeeIntegration, ErrorResponse]),
  },
  {
    method: "get",
    path: "/freee/mappings/customers",
    alias: "Freee_getCustomerMappings",
    requestFormat: "json",
    response: z.union([z.array(CustomerFreeeMapping), ErrorResponse]),
  },
  {
    method: "post",
    path: "/freee/mappings/customers",
    alias: "Freee_createCustomerMapping",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CreateCustomerMappingInput,
      },
    ],
    response: z.union([CustomerFreeeMapping, ErrorResponse]),
  },
  {
    method: "get",
    path: "/freee/mappings/deals",
    alias: "Freee_getDealMappings",
    requestFormat: "json",
    response: z.union([z.array(DealFreeeMapping), ErrorResponse]),
  },
  {
    method: "post",
    path: "/freee/mappings/deals",
    alias: "Freee_createDealMapping",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CreateDealMappingInput,
      },
    ],
    response: z.union([DealFreeeMapping, ErrorResponse]),
  },
  {
    method: "get",
    path: "/freee/partners",
    alias: "Freee_getPartners",
    requestFormat: "json",
    response: z.union([z.array(FreeePartner), ErrorResponse]),
  },
  {
    method: "get",
    path: "/freee/sync/logs",
    alias: "Freee_getSyncLogs",
    requestFormat: "json",
    parameters: [
      {
        name: "limit",
    ...
    response: z.union([z.array(FreeeSyncLog), ErrorResponse]),
  },
  {
    method: "post",
    path: "/freee/sync/logs",
    alias: "Freee_createSyncLog",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: CreateSyncLogInput,
      },
    ],
    response: z.union([FreeeSyncLog, ErrorResponse]),
  },
  {
    method: "put",
    path: "/freee/sync/logs/:id",
    alias: "Freee_updateSyncLog",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: UpdateSyncLogInput,
      },
      {
        name: "id",
        type: "Path",
  ...
  {
    method: "post",
    path: "/freee/sync/partners/export",
    alias: "Freee_syncPartnersToFreee",
    requestFormat: "json",
    response: z.union([FreeeSyncLog, ErrorResponse]),
  },
  {
    method: "post",
    path: "/freee/sync/partners/import",
    alias: "Freee_syncPartnersFromFreee",
    requestFormat: "json",
    response: z.union([FreeeSyncLog, ErrorResponse]),
  },
  {
    method: "put",
    path: "/freee/tokens",
    alias: "Freee_updateTokens",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: UpdateFreeeTokensInput,
      },
    ],
    response: z.union([FreeeOAuthTokens, ErrorResponse]),
  },
]);
