...
export const CreateChatRoomInput = z
    ...
    .partial()
    .passthrough();
export const ErrorResponse = z.object({ error: z.string(), details: z.unknown().optional() }).passthrough();
...
export const AddParticipantInput = z
    ...
    .passthrough();
export const Chats_markMessagesAsRead_Body = z.object({ messageIds: z.array(z.string()) }).passthrough();
...
export const UpdateDealInput = z
    ...
    .partial()
    .passthrough();
export const LeadStatus = z.enum(["NEW", "CONTACTED", "QUALIFIED", "UNQUALIFIED", "CONVERTED"]);
export const Lead = z
    .object({
        id: z.string(),
        customerId: z.string().optional(),
...
export const UpdatePipelineStageInput = z
    ...
    .partial()
    .passthrough();
export const EmailStatus = z.enum(["PENDING", "SENT", "DELIVERED", "BOUNCED", "FAILED"]);
...
export const Emails_sendEmailWithTemplate_Body = z
    ...
    .partial()
    .passthrough();
export const EmailTemplateCategory = z.enum(["MARKETING", "TRANSACTIONAL", "SUPPORT", "NOTIFICATION"]);
...
export const Portfolio = z
    ...
    .passthrough();
export const PostContent = z.object({ html: z.string(), raw: z.unknown().optional() }).passthrough();
export const Post = z
    .object({
        id: z.string(),
        title: z.string(),
    ...
    .passthrough();
export const InquiryStatus = z.enum(["OPEN", "IN_PROGRESS", "WAITING_CUSTOMER", "RESOLVED", "CLOSED"]);
