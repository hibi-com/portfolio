...
const CreateChatRoomInputSchema = z
    .object({
        customerId: z.string().uuid().optional(),
        inquiryId: z.string().uuid().optional(),
        name: z.string().optional(),
...
const AddParticipantInputSchema = z
    .object({
        userId: z.string().uuid().optional(),
        name: z.string(),
...
const listRoomsRoute = createRoute({
    ...
    responses: {
        200: {
            content: { "application/json": { schema: z.array(ChatRoomSchema) } },
...
const getRoomRoute = createRoute({
    ...
    responses: {
        200: {
            content: { "application/json": { schema: ChatRoomWithParticipantsSchema } },
