...
async function timed(name: string, fn: () => Promise<void>): Promise<ScenarioResult> {
...
export async function runCriticalScenarios(browser: Browser, targets: Targets): Promise<ScenarioResult[]> {
